    ...
    const defaultLocations: StockLocation[] = [
        {
            ...
            stock: {
                ...
                'COMMERCIAL_19KG': { filled: 15, empty: 5 },
                'COMMERCIAL_14KG': { filled: 10, empty: 3 },
            },
        ...
        },
        {
            ...
            stock: {
                ...
                'COMMERCIAL_19KG': { filled: 5, empty: 2 },
                'COMMERCIAL_14KG': { filled: 3, empty: 1 },
            },
            updatedAt: new Date().toISOString(),
        },
        {
            ...
            stock: {
                ...
                'COMMERCIAL_19KG': { filled: 2, empty: 0 },
                'COMMERCIAL_14KG': { filled: 1, empty: 0 },
            },
            updatedAt: new Date().toISOString(),
        },
        {
            ...
            stock: {
                ...
                'COMMERCIAL_19KG': { filled: 1, empty: 0 },
                'COMMERCIAL_14KG': { filled: 1, empty: 0 },
            },
            updatedAt: new Date().toISOString(),
        },
